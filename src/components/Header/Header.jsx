        ...
        <div className='bg py-5'>
            <div className='my-container flex justify-between items-center relative'>
                ...
                <nav className='md:hidden'>
                    ...
                    {
                        isMenuOpen && (
                            <div className=' absolute left-3 top-3  w-96 bg-white p-4 rounded-lg duration-1000'>
                                <button onClick={() => setIsMenuOpen(false)}>
                                    <XMarkIcon className="h-6 w-6 text-blue-700 absolute top-3 right-3" />
                                </button>
                                <ul className='flex flex-col gap-3 items-center absolute left-2 top-2 py-5 bg-black text-white rounded-lg w-5/6 '>
